    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center">
        <div className="h-16 w-16 rounded-2xl bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-2xl shadow-blue-500/20 mb-6 scale-110">
          <Sparkles className="h-10 w-10 text-slate-900 dark:text-white animate-pulse" />
        </div>
        <Loader2 className="h-8 w-8 animate-spin text-blue-500 mb-4" />
        <p className="text-slate-600 dark:text-slate-400 font-medium animate-pulse text-lg">Redirecting to dashboard...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-blue-900/20 via-slate-50 dark:via-slate-950 to-slate-50 dark:to-slate-950" />
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="#pricing" className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">
                Pricing
              </Link>
              <Link href="/marketplace" className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">
                Templates
              </Link>
            </div>
            ...
            <div className="flex items-center gap-4">
              <ThemeToggleButton />
              <Link href="/login">
                <Button variant="ghost" className="text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-white/10">
                  Log in
                </Button>
              </Link>
              <Link href="/register">
            ...
            <FadeInUp delay={0.5}>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="text-lg px-8 h-14 border-slate-200 dark:border-slate-700 bg-white/50 dark:bg-white dark:bg-slate-900/50 hover:bg-slate-100 dark:bg-slate-800 hover:border-slate-300 dark:border-slate-600 backdrop-blur-sm"
                >
          ...
          <FadeInUp delay={0.7}>
            <div className="mt-20 max-w-6xl mx-auto">
              <div className="relative">
                ...
                <div className="relative rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-white dark:bg-slate-900/80 backdrop-blur-xl shadow-2xl">
                  {/* Browser bar */}
                  <div className="flex items-center gap-2 px-4 py-3 bg-slate-100/50 dark:bg-slate-100 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700">
                    ...
                    <div className="flex-1 flex justify-center">
                      <div className="px-4 py-1 bg-slate-200/50 dark:bg-slate-200 dark:bg-slate-700/50 rounded-lg text-xs text-slate-600 dark:text-slate-400">
                  ...
                  {/* Preview content */}
                  <div className="aspect-video bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 relative group overflow-hidden">
                    <Image
                ...
                <FloatingElement duration={4} distance={15} className="absolute -right-12 top-20 hidden lg:block">
                  <div className="bg-white/90 dark:bg-slate-100 dark:bg-slate-800/90 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-600 dark:text-slate-400">12 slides in 8 seconds</p>
                      </div>
                    </div>
                  </div>
                </FloatingElement>
                  ...
                  <div className="bg-white/90 dark:bg-slate-100 dark:bg-slate-800/90 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-600 dark:text-slate-400">3 users editing</p>
                      </div>
                    </div>
                  </div>
                </FloatingElement>
...
function FeatureCard({
  ...
  return (
    <ScaleOnHover scale={1.02}>
      <div className="h-full rounded-2xl bg-white/50 dark:bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 hover:border-slate-200 dark:border-slate-700 transition-all backdrop-blur-sm group overflow-hidden">
        {image && (
    ...
    <ScaleOnHover scale={1.02}>
      <div
        className={`relative h-full p-8 rounded-2xl border backdrop-blur-sm transition-all ${highlighted
          ? "bg-linear-to-b from-blue-100 to-purple-100 border-blue-300 dark:from-blue-950/50 dark:to-purple-950/50 dark:border-blue-500/50 shadow-2xl shadow-blue-500/10"
        ...
        <Link href="/register" className="block">
          <Button
            ...
            className={`w-full ${highlighted
              ...
              : "border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:bg-slate-800"
              }`}
          >
            {buttonText}
          </Button>

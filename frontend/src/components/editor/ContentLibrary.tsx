...
import { NativeAssetLibrary } from './native-asset-library';
...
export function ContentLibrary({
    ...
    const [activeTab, setActiveTab] = useState<'templates' | 'my-library' | 'shapes'>(
        'templates',
    );
        ...
        <div className="space-y-4">
            ...
            <div className="flex gap-2 border-b border-slate-200">
                ...
                <button
                    ...
                    className={`px-4 py-2 font-medium transition-colors ${activeTab === 'shapes'
                        ? 'border-b-2 border-blue-500 text-blue-600'
                        : 'text-slate-600 hover:text-slate-900'
                        }`}
                >
            ...
            {/* Shapes & Icons Tab */}
            {activeTab === 'shapes' && (
                <div className="max-h-100 overflow-y-auto -mx-2">
                    <NativeAssetLibrary
                        onInsertAsset={(asset) => {
                            if (onInsertBlock) {
                                onInsertBlock({
            ...
            {/* Filters (templates/my-library only) */}
            {activeTab !== 'shapes' && (
                <>

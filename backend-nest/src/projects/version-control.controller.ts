...
import { VersionControlService, PresentationVersion, VersionComparison } from './version-control.service';
...
export class VersionControlController {
  ...
  async createVersion(
    ...
    @Request() req: any,
    @Body() body: { name?: string; description?: string; isMilestone?: boolean }
  ...
  async restoreVersion(
    ...
    await this.versionControlService.restoreVersion(projectId, versionId, req.user.id);
  ...
  async compareVersions(
    ...
    return this.versionControlService.compareVersions(projectId, versionAId, versionBId);
  }
